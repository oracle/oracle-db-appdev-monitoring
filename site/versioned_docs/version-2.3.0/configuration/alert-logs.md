...
If the exporter is configured to scrape multiple databases, it is recommended to set the `log.perDatabaseFiles` property to `true`, creating a separate log file for each database.  
