...
- Alert logging now supports optional INFO and ERROR log categorization using the underlying row `message_level`. To enable this feature, set `log.messageLevelEnabled=true` (Disabled by default). 
